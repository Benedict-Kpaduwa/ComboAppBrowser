...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setUpDrawer() {
        ...
        binding.navToolbar.navTerms.setOnClickListener(v -> openAboutPage());
        binding.navToolbar.navSupport.setOnClickListener(v -> openAboutPage());
        binding.navToolbar.navAboutus.setOnClickListener(v -> openAboutPage());
        binding.navToolbar.navFaq.setOnClickListener(v -> openAboutPage());
        binding.navToolbar.navShare.setOnClickListener(v -> {
            try {
                Intent shareIntent = new Intent(Intent.ACTION_SEND);
                shareIntent.setType("text/plain");
                shareIntent.putExtra(Intent.EXTRA_SUBJECT, "App Browser");
        ...
        binding.navToolbar.navProducts.setOnClickListener(v -> getSupportFragmentManager().beginTransaction().addToBackStack(null).add(R.id.frame, new ProductsFragment()).commit());
